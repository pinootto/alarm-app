...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        rxvTime = (TextView) findViewById(R.id.rxvTime);
		...
		Log.i(TAG, "onCreate");
		Log.i(TAG, tts.getEngines().toString());

		clientId = Utils.generateClientId("main");
...
//                    setMessageNotification("debug", "main: reconnected");
					Log.i(TAG, "connectComplete: reconnect");
                }
                try {
...
//        }
		...
		try {
            Toast.makeText(this, "publishing to " + Constants.PUBLISH_TOPIC, Toast.LENGTH_SHORT).show();
			pahoMqttClient.publishMessage(mqttAndroidClient, msg, Constants.QOS, Constants.PUBLISH_TOPIC);
	...
	public void onMessageEvent(MessageEvent event) {
		...
		rxvTime.setText(new Date().toString());
	}
